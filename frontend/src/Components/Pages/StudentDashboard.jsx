...
const StudentDashboard = () => {
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gray-50">
      <h1 className="text-4xl font-bold text-center text-gray-800 mb-6">Welcome to Your Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white shadow-lg rounded-lg p-5 hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-gray-500">Check your upcoming assignments and due dates.</p>
        ...
        <div className="bg-white shadow-lg rounded-lg p-5 hover:shadow-xl transition-shadow duration-300">
          ...
          <p className="text-gray-500">Keep track of important dates and events.</p>
      ...
      <div className="mt-8 bg-white shadow-lg rounded-lg p-5">
        <h2 className="text-2xl font-semibold text-gray-700">Recent Notifications</h2>
