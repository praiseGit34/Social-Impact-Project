        ...
        <Container>
            <Row>
                ...
                <Col xs="9" className="content">
                    ...
                    <p>Here you can manage your classes, track student progress, and create assignments.</p>
                    <p>Explore the sidebar to navigate between your profile, courses, and assignments.</p>
