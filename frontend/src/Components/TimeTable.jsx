...
const timetableData = [
  ...
  {
    day: 'Tuesday',
    periods: ['Art', 'Math', 'Science', 'Computer Science', 'History'],
  },
  {
    day: 'Wednesday',
    periods: ['English', 'Math', 'Geography', 'Science', 'PE'],
  },
  { day: 'Thursday', periods: ['History', 'Math', 'English', 'Art', 'Music'] },
  {
    day: 'Friday',
    periods: ['Math', 'Science', 'History', 'PE', 'Computer Science'],
  },
];
      ...
      <table className="min-w-full border-collapse border border-gray-300 mx-auto">
        ...
        <tbody className="text-gray-700">
          {timetableData.map(row => (
            <tr key={row.day} className="hover:bg-blue-100">
